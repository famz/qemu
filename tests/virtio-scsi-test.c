...
static const QSCSIDiskTestData scsi_disk_test_data[] = {
    ...
    /* WRITE (6) */
    {
        .name = "write_6.second_sector",
        .cdb = { 0x0A, 0x00, 0x00, 0x01, 0x01, 0x00 },
        .data_len = 512,
        .sector = 1,
        .is_write = true,
        .get_data = sector_data,
    }, {
        .name = "write_6.largest_lba",
        .cdb = { 0x0A, MAKE_LBA3(0x1FFFFF / 512),
                 0x01 },
        .data_len = 512,
        .sector = 0x1FFFFF / 512,
        .is_write = true,
        ...
        .get_data = zero_data,
        .status = CHECK_CONDITION,
        .sense = { .key = ABORTED_COMMAND, .asc = 0x00, .ascq = 0x06 },
    },

    /* WRITE (10) */
    {
        .name = "write_10.0blocks",
        .cdb = { 0x2A, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 },
        .data_len = 512,
        .is_write = true,
        .get_data = zero_data,
    }, {
        .name = "write_10.first_sector",
        .cdb = { 0x2A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 },
        .data_len = 512,
        .sector = 0,
        .is_write = true,
        .get_data = sector_data,
    }, {
        .name = "write_10.second_sector",
        .cdb = { 0x2A, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00 },
        .data_len = 512,
        .sector = 1,
        .is_write = true,
        .get_data = sector_data,
    }, {
        .name = "write_10.last_sector",
        .cdb = { 0x2A, 0x00,
                 MAKE_LBA4(IMG_SIZE / 512 - 1),
                 0x00, 0x00, 0x01, 0x00 },
        .data_len = 512,
        ...
        .name = "write_10.4k",
        .cdb = { 0x2A, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x08, 0x00 },
        .data_len = 512 * 8,
        .sector = 8,
        .is_write = true,
        .get_data = sector_data,
    }, {
        .name = "write_10.unaligned_4k",
        .cdb = { 0x2A, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x08, 0x00 },
        .data_len = 512 * 8,
        .sector = 1,
        .is_write = true,
        .get_data = sector_data,
        ...
        .name = "write_10.big",
        .cdb = { 0x2A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x8, 0x00, 0x00 },
        .data_len = 512 * 0x800,
        .sector = 0,
        .is_write = true,
        .get_data = sector_data,
    }, {
        .name = "write_10.buffer_larger_than_xfer",
        .cdb = { 0x2A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 },
        .data_len = 1024,
        .sector = 0,
        .is_write = true,
        ...
        .name = "write_10.beyond_eol",
        .cdb = { 0x2A, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 },
        .data_len = 512,
        .is_write = true,
        .status = CHECK_CONDITION,
        .sense = { .key = ILLEGAL_REQUEST, .asc = 0x21 },
    }, {
        .name = "write_10.wrprotect",
        .cdb = { 0x2A, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 },
        .data_len = 512,
        .is_write = true,
        .status = CHECK_CONDITION,
        .sense = { .key = ILLEGAL_REQUEST, .asc = 0x24 },
        ...
        .name = "write_10.fua",
        .cdb = { 0x2A, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 },
        .data_len = 512,
        .sector = 0,
        .is_write = true,
        .get_data = sector_data,
    ...
    /* WRITE (12) */
    {
        .name = "write_12.0blocks",
        .cdb = { 0xAA, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 },
        .data_len = 512,
        .is_write = true,
        .get_data = zero_data,
    }, {
        .name = "write_12.first_sector",
        .cdb = { 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .sector = 0,
        .is_write = true,
        .get_data = sector_data,
    }, {
        .name = "write_12.second_sector",
        .cdb = { 0xAA, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .sector = 1,
        .is_write = true,
        .get_data = sector_data,
    }, {
        .name = "write_12.last_sector",
        .cdb = { 0xAA, 0x00, MAKE_LBA4(IMG_SIZE / 512 - 1),
                 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .sector = IMG_SIZE / 512 - 1,
        .is_write = true,
        ...
        .name = "write_12.4k",
        .cdb = { 0xAA, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x08 },
        .data_len = 512 * 8,
        .sector = 8,
        .is_write = true,
        .get_data = sector_data,
    }, {
        .name = "write_12.unaligned_4k",
        .cdb = { 0xAA, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x08 },
        .data_len = 512 * 8,
        .sector = 1,
        .is_write = true,
        .get_data = sector_data,
        ...
        .name = "write_12.big",
        .cdb = { 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00 },
        .data_len = 512 * 0x800,
        .sector = 0,
        .is_write = true,
        .get_data = sector_data,
    }, {
        .name = "write_12.buffer_larger_than_xfer",
        .cdb = { 0xAA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 },
        .data_len = 1024,
        .sector = 0,
        .is_write = true,
        ...
        .name = "write_12.beyond_eol",
        .cdb = { 0xAA, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .is_write = true,
        .status = CHECK_CONDITION,
        .sense = { .key = ILLEGAL_REQUEST, .asc = 0x21 },
    }, {
        .name = "write_12.wrprotect",
        .cdb = { 0xAA, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .is_write = true,
        .status = CHECK_CONDITION,
        .sense = { .key = ILLEGAL_REQUEST, .asc = 0x24 },
        ...
        .name = "write_12.fua",
        .cdb = { 0xAA, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .sector = 0,
        .is_write = true,
        .get_data = sector_data,
    ...
    /* WRITE (16) */
    {
        .name = "write_16.0blocks",
        .cdb = { 0x8A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x00 },
        .data_len = 512,
        .is_write = true,
        .get_data = zero_data,
    }, {
        .name = "write_16.first_sector",
        .cdb = { 0x8A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .is_write = true,
        ...
        .name = "write_16.second_sector",
        .cdb = { 0x8A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
                 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .is_write = true,
        .sector = 1,
        ...
        .name = "write_16.last_sector",
        .cdb = { 0x8A, 0x00, MAKE_LBA8(IMG_SIZE / 512 - 1),
                 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .is_write = true,
        .sector = IMG_SIZE / 512 - 1,
        ...
        .name = "write_16.4k",
        .cdb = { 0x8A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08,
                 0x00, 0x00, 0x00, 0x08 },
        .data_len = 512 * 8,
        .is_write = true,
        .sector = 8,
        ...
        .name = "write_16.buffer_larger_than_xfer",
        .cdb = { 0x8A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x01 },
        .data_len = 1024,
        .is_write = true,
        ...
        .name = "write_16.beyond_eol",
        .cdb = { 0x8A, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .is_write = true,
        .status = CHECK_CONDITION,
        ...
        .name = "write_16.wrprotect",
        .cdb = { 0x8A, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .is_write = true,
        .status = CHECK_CONDITION,
        ...
        .name = "write_16.fua",
        .cdb = { 0x8A, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                 0x00, 0x00, 0x00, 0x01 },
        .data_len = 512,
        .sector = 0,
        .get_data = sector_data,
