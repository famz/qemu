...
check-block-queue: check-block-queue.o qemu-tool.o qemu-error.o qemu-thread.o $(oslib-obj-y) $(filter-out block-queue.o,$(block-obj-y)) $(qobject-obj-y) qemu-timer-common.o
